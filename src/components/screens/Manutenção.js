...
import styles from "../../styles/ManutencaoStyles";
...
export default function Manutencao() {
  ...
  useEffect(() => {
    const fetchServicos = async () => {
      try {
        const data = await loadServicesByCategory("nails manutenção");
        setServicos(data);
      } catch (error) {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.titulo}>Serviços de Manutenção</Text>
