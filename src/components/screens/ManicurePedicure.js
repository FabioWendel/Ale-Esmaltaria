...
import styles from "../../styles/ManicurePedicureStyles";
...
export default function ManicurePedicure() {
  ...
  useEffect(() => {
    const fetchServicos = async () => {
      try {
        const data = await loadServicesByCategory("manicure e pedicure");
        setServicos(data);
      } catch (error) {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.titulo}>Serviços de Manicure e Pedicure</Text>
