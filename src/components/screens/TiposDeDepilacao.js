...
import styles from "../../styles/TiposDeDepilacaoStyles";

export default function TiposDeDepilacao() {
  ...
  useEffect(() => {
    const fetchServicos = async () => {
      try {
        const data = await loadServicesByCategory("depilação");
        setServicos(data);
      } catch (error) {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.titulo}>Serviços de Depilação</Text>
