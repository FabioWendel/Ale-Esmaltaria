...
import styles from "../../styles/DesignerDeSobrancelhasStyles";

export default function DesignerDeSobrancelhas() {
  ...
  useEffect(() => {
    const fetchServicos = async () => {
      try {
        const data = await loadServicesByCategory("sobrancelha");
        setServicos(data);
      } catch (error) {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.titulo}>Serviços de Designer de Sobrancelhas</Text>
