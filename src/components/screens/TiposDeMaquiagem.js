...
import styles from "../../styles/TipoMaquiagemStyles";

export default function TiposDeMaquiagem() {
  ...
  useEffect(() => {
    const fetchServicos = async () => {
      try {
        const data = await loadServicesByCategory("make");
        setServicos(data);
      } catch (error) {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.titulo}>Serviços de Maquiagem</Text>
